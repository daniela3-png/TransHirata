...
public class MantenimientoDAO {
    ...
    public int agendarMantencion(String patente, int kmProg, String solicitante, java.sql.Date fecha) {
        ...
        try (Connection con = ConexionBD.conectar(); PreparedStatement ps = con.prepareStatement(sqlInsert, Statement.RETURN_GENERATED_KEYS)) {
            ps.setString(1, patente);
            ps.setInt(2, kmProg);
            ps.setDate(3, fecha);
    ...
    public boolean finalizarServicio(String idTicket, String detalle, String patente, int nuevoKm) {
        ...
        try (Connection con = ConexionBD.conectar()) {
            ...
            try (PreparedStatement ps1 = con.prepareStatement(sqlTicket); PreparedStatement ps2 = con.prepareStatement(sqlCamion)) {
    ...
    public int crearMantencionDirecta(String patente, int kmActual, String detalle, String solicitante) {
        ...
        try (Connection con = ConexionBD.conectar(); PreparedStatement ps = con.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
